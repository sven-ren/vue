<template>
  <div class="MediaSource">
    <audio class="pre_load_music" preload="auto" src="../assets/material/media/wind.ogg"></audio>
    <audio class="pre_load_music" preload="auto" src="../assets/material/media/boommusic3.mp3"></audio>
